...
class Signup(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.lbl_password = tk.Label(
            self, height=1, text="Password:", width=20, justify="left", font=style.label_font, anchor=tk.W)
        ...
        self.lbl_checkpas = tk.Label(
            self, height=1, text="Password again:", width=20, justify="left", font=style.label_font, anchor=tk.W)
        self.lbl_checkpas.grid(row=5, column=1, sticky=tk.E+tk.W,
                               padx=10, pady=0, columnspan=2)
        self.txt_checkpas = tk.Entry(
            self, show="*", width=36, bg="#FFFFFF", font=style.entry_font)
        self.txt_checkpas.grid(row=6, column=1, sticky=tk.E,
                               padx=10, pady=10, columnspan=2)

        self.btn_back = tk.Button(
            self, text="Back to\nlog in", width=10, height=2, font=style.btn_font,
        ...
        self.btn_signup = tk.Button(
            self, text="Sign up", width=10, height=2, font=style.btn_font,
            activebackground=style.btn_style['actbg'], bg=style.btn_style['bg'], fg=style.btn_style['fg'])
